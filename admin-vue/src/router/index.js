	...
	},
	{
		...
		children: [
			...
			},
			{
				path: 'websites',
				name: 'WebsitesList',
				component: () => import('@/views/page/WebsitesList'),
				meta: {title: '网站链管理', icon: 'el-icon-s-promotion'}
			},
			{
				path: 'about',
				name: 'About',
...
/*			{
				path: 'qiniu',
				name: 'QiniuManage',
				component: () => import('@/views/pictureHosting/QiniuManage'),
				meta: {title: '七牛云', icon: 'el-icon-folder-opened'}
			},*/
/*			{
				path: 'upyun',
				name: 'UpyunManage',

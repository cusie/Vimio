...
import top.vimio.model.blogdto.VisitLogRemark;
...
import top.vimio.utils.AopUtils;
...
public class VisitLogAspect {
     ...
     * @return
     */
    private VisitLog handleLog(ProceedingJoinPoint joinPoint, VisitLogger visitLogger, HttpServletRequest request, ResponseResult result,
     ...
     * @return
     */
    private VisitLogRemark judgeBehavior(VisitBehavior behavior, Map<String, Object> requestParams, ResponseResult result) {
        String remark = "";

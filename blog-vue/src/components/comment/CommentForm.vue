<template>
	...
	<div class="form">
        ...
        <img src="https://cdn.jsdmirror.com/gh/vi-mio/resources/emoji/xiaoyou/57.png" @click="showEmojiBox" style="width: 32px; height: 32px;"/>
				...
				<div class="emoji-box" v-show="emojiShow">
					...
					<div class="emoji-tabs">
						<a class="tab-link" :class="{'on':activeEmojiTab===0}" @click="activeEmojiTab=0">
							<img src="https://cdn.jsdmirror.com/gh/vi-mio/resources/emoji/TV/1.png">
						</a>
						<a class="tab-link" :class="{'on':activeEmojiTab===1}" @click="activeEmojiTab=1">
							<img src="https://cdn.jsdmirror.com/gh/vi-mio/resources/emoji/aru/1.png">
						</a>
						<a class="tab-link" :class="{'on':activeEmojiTab===2}" @click="activeEmojiTab=2">
							<img src="https://cdn.jsdmirror.com/gh/vi-mio/resources/emoji/xiaoyou/1.png">
						</a>
					</div>
				</div>
			</div>

<template>
	<div class="site">
		<!--顶部导航-->
		<Mio :blogName="siteInfo.blogName" :categoryList="categoryList"/>
    ...
    <!--APlayer-->
		...
		<el-backtop style="box-shadow: none;background: none;z-index: 9999;">
			<img src="/img/paper-plane.png" style="width: 135px;height: 110px;">
		</el-backtop>
		<!--底部footer-->
...
<script>
	...
	import Mio from "@/components/index/Vimio.vue";
  ...
  import live2d from '@/components/live2d/live2d'
	...
	export default {
		name: "Index",
		components: {live2d, Header, BlogPasswordDialog, Tocbot, RandomBlog, Tags, Mio, Footer, Introduction},
		data() {
			return {
				siteInfo: {
					blogName: '',
...
<style scoped>
    ...
    background-image: url("https://cdn.jsdmirror.com/gh/vi-mio/resources/Images/background.png")!important;
